...
40     \textcolor{comment}{/* Correct the minimum height of the lockbutton. Normally it jumps to 24,}
41 \textcolor{comment}{     * which results in an ugly difference to the pushbutton.}
42 \textcolor{comment}{     */}
43     ui->lockStickyButton->setMinimumHeight(23);
44 
45     connect(ui->pushStickyButton, &QPushButton::pressed,
46             [\textcolor{keyword}{this}]\{ QStickyButton::onPushChanged(\textcolor{keyword}{true}); \});
47     connect(ui->pushStickyButton, &QPushButton::released,
48             [\textcolor{keyword}{this}]\{ QStickyButton::onPushChanged(\textcolor{keyword}{false}); \});
49     connect(ui->lockStickyButton, &QPushButton::toggled,
50             \textcolor{keyword}{this}, &QStickyButton::onLockToggle);
51 \}
\end{DoxyCode}
...
Definition at line 53 of file Q\-Sticky\-Button.\-cpp.


\begin{DoxyCode}
54 \{
55     \textcolor{keyword}{delete} ui;
56 \}
\end{DoxyCode}
...
Definition at line 111 of file Q\-Sticky\-Button.\-cpp.


\begin{DoxyCode}
112 \{
113     \textcolor{keywordflow}{return} (ui->pushStickyButton->isChecked()                                  |
114             ui->lockStickyButton->isChecked());
115 \}
\end{DoxyCode}
...
Definition at line 94 of file Q\-Sticky\-Button.\-cpp.


\begin{DoxyCode}
95 \{
96     \textcolor{keywordflow}{if} (pressed) \{
97         ui->pushStickyButton->setCheckable(\textcolor{keyword}{true});
98         ui->pushStickyButton->setChecked(\textcolor{keyword}{true});
99         ui->lockStickyButton->setChecked(\textcolor{keyword}{true});
100     \} \textcolor{keywordflow}{else} \{
101         \textcolor{comment}{/* Need to uncheck before setting it uncheckable. Otherwise the button}
102 \textcolor{comment}{         * remains checked.}
103 \textcolor{comment}{         */}
104         ui->pushStickyButton->setChecked(\textcolor{keyword}{false});
105         ui->pushStickyButton->setCheckable(\textcolor{keyword}{false});
106         ui->lockStickyButton->setChecked(\textcolor{keyword}{false});
107     \}
108 \}
\end{DoxyCode}
...
Definition at line 59 of file Q\-Sticky\-Button.\-cpp.


\begin{DoxyCode}
60 \{
61     ui->pushStickyButton->setText(\hyperlink{class_q_sticky_button_a32a1b2b10c91b85f96e8e01876a81c18}{title});
62 \}
\end{DoxyCode}
